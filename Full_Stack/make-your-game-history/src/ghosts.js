...
//import { setBossInvincible, bossInvincible } from "./game.js";

export default class Enemy {
    constructor(x, y, tileSize, velocity, tileMap, isBoss) {
        this.x = x;
        this.y = y;
        ...
        if (pacman.powerDotAboutToExpire) {
            ...
            if (this.scaredAboutToExpireTimer === 0) {
                ...
                if (this.bossInvincible) {
                    this.image = this.invincibleGhost;
                } else {
                    if (this.image === this.scaredGhost || this.image === this.invincibleGhost) {
    ...
    #loadImg() {
        if (!this.isBoss) {
            ...
            // boss ghost images
            this.normalGhost = new Image();
            this.normalGhost.src = "../graphics/bossGhost.png";

            this.scaredGhost = new Image();
            this.scaredGhost.src = "../graphics/bossScaredGhost.png";

            this.scaredGhost2 = new Image();
            this.scaredGhost2.src = "../graphics/bossScaredGhost2.png";

            this.invincibleGhost = new Image();
            this.invincibleGhost.src = "../graphics/bossGhostInvincible.png";
        }
