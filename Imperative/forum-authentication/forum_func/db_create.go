...
func addFirstRecords(databaseName string) {
	userInsert := `insert into users (user_email, user_method, user_name, user_pw, user_type) values('admin@admin.admin','password','Admin','d121150ba9e51fff', 'ADMIN')` // SQL Statement for Create Table
